...
public class ShortestDistancefromAllBuildings {
	...
	private void shortestDistanceHelper(int row, int col, int dist, int[][] grid, int[][] reach, int[][] minDistance,
	...
	private void fill(int row, int col, int dist, int[][] grid, int[][] reach, int[][] minDistance, boolean[][] visited,
			Queue<Integer> queue) {
		int m = grid.length;
		int n = grid[0].length;
